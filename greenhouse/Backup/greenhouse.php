...
<body>
    ...
    <div class="connection-log-container">
        ...
        <div class="side-info-group">
            ...
            <div class="info-box" id="temp-control-box">
                ...
                <div class="temp-controls-group">
                    ...
                    <div class="control-pair">
                        <button class="action-btn curtain-open" data-action="curtainOpen">☀️ Mở Rèm (-10)</button>
                        <button class="action-btn curtain-close" data-action="curtainClose">🌙 Đóng Rèm</button>
                    </div>
                </div>
            </div>
        </div>
